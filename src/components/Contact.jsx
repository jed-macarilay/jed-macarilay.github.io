        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-4">
            <a
              ...
              className="flex items-center justify-between w-full border border-subtle rounded-lg px-6 py-4 hover:border-accent hover:bg-white transition-all group"
            >
              <div>
            ...
            >
              <div>
                ...
                <p className="font-body text-sm text-ink">github.com/jed-macarilay</p>
              </div>
              <span className="text-muted group-hover:text-accent transition-colors">-&gt;</span>
            </a>

            <div className="flex items-center justify-between w-full border border-subtle rounded-lg px-6 py-4">
              <div>
